...
def main(argv):
    ...
    stats_group.add_argument("--hrv_monitoring", help="Download and/or import hrv monitoring data.", dest='stats', action='append_const', const=Statistics.hrv_monitoring)
